...
A felhasználók adatainak, beállításainak tárolására, kezelésére a Cloud Firestore nevű no-sql adatbázist használtam, mely a CRUD%
\footnote{ %
